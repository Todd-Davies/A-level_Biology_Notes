...
\begin{center}
	...
	%Glucose->TP
		\draw[->] (2.1,1) -- (3.9,1);
	%ATP->ADP + pi
		\draw[thick] plot [smooth,tension=1] coordinates{(2.2, 2.5) (3, 1)
		(3.7, 2.5)};
	...
	%TP->Pyruvate
		\draw[->] (6.1,1) -- (7.9,1);
	%ADP+pi->ATP
		\draw[thick] plot [smooth,tension=1] coordinates{(6.2, 2.5) (7, 1)
		(7.7, 2.5)};
		\draw [thick, ->] (7.7, 2.5) -- (7.701, 2.51);   %Right
		\node at (6.1, 2.7) {4ADP + 4pi};
		\node at (7.8, 2.75) {4ATP};
	%NAD->reduced NAD
		\draw[thick] plot [smooth,tension=1] coordinates{(6.2, -0.5) (7, 1)
		(7.7, -0.5)};
...
\begin{center}
	...
	%NAD->reduced NAD
		\draw plot [smooth,tension=1] coordinates{(3.2, -0.5) (4, 1)
		(4.7, -0.5)};
	...
	%Coenzyme A
		\draw plot [smooth,tension=1] coordinates{(7.5, -0.7) (7.75, 0.1)
		(8, 1)};
...
\begin{center}
	\begin{tikzpicture}
		...
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm]
		(acetylcoenzymeA) at (0,0) {\makecell[c]{2 carbon\\acetlycoenzyme A}};
		
		\node[connector] (center) at (0, -2) {};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm] (6C) at
		(4,-2) {\makecell[c]{6 carbon molecule}};
		
		\node[connector] (6-5) at (2, -3) {};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm] (5C) at
		(0,-4) {\makecell[c]{5 carbon molecule}};
		
		\node[connector] (5-4) at (-2, -3) {};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm] (4C) at
		(-4,-2) {\makecell[c]{4 carbon molecule}};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=2cm] (1_CO2) at
		(4.5,-3.5) {\makecell[c]{Carbon dioxide}};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm]
		(electrons_to_NAD) at (4,-6) {\makecell[c]{Electrons
		\\transferred\\to NAD}};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm] (2_CO2) at
		(-5,-3.4) {\makecell[c]{Carbon dioxide}};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm] (ATP) at
		(-4,-4.6) {\makecell[c]{ATP}};
		
		\node[thick,draw,minimum height=0.5cm,minimum width=3.2cm]
		(electrons_to_NAD_FAD) at (-2,-6.5) {\makecell[c]{Electrons
		\\transferred to\\NAD and FAD}};
